...
public class CompassView extends ImageButton implements
		SensorEventListener {
	...
	public void setBackgroundBitmap(Bitmap bitmap) {
		mBitmapBackground = Bitmap.createScaledBitmap(bitmap,
	...
	public void setOrientationBitmap(Bitmap bitmap) {
		mBitmapOrient = Bitmap.createScaledBitmap(bitmap,
				getLayoutParams().width, getLayoutParams().height,
				true);
	}
	...
	protected void onDraw(Canvas canvas) {
		if (mValues != null) {
			...
			canvas.rotate(mValues[0], getLayoutParams().width / 2,
