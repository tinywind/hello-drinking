...
public class MapActivity extends NMapActivity {
	...
	private void testPOIdataOverlay() {
		...
		poiData.addPOIitem(127.0630205, 37.5091300, "Pizza 777-111", markerId,
				0);
	...
	private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
		...
		public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
			...
			if (errorInfo == null) { // success
				...
				Toast.makeText(MapActivity.this, errorInfo.toString(),
						Toast.LENGTH_LONG).show();
			}
		}
			...
			if (itemOverlay instanceof NMapPOIdataOverlay) {
				...
				if (!poiDataOverlay.isFocusedBySelectItem()) {
					...
					if (countOfOverlappedItems > 1) {
						...
						Toast.makeText(MapActivity.this, text, Toast.LENGTH_LONG)
								.show();
						return null;
					}
				}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menuItem = subMenu.add(0, MENU_ITEM_TEST_POI_DATA, Menu.NONE,
				"Test POI data");
